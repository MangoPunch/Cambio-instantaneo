...
F1::    ;activa el codigo al presionar F1, es para FireFox
 ...
 GroupAdd, MPfirefox, ahk_class MozillaWindowClass
 if WinActivate ("ahk_exe firefox.exe")
   GroupActivate, MPfirefox, r
 else
    WinActivate ahk_class MozillaWindowClass ; si existe cambia a esa ventana.
 Return
...
#IfWinActive ahk_class Photoshop
  ...
  else WinActivate ahk_class Qt5QWindowIcon ;cambia entre ambos programas
Return

#If ; detiene el uso de comandos dependendiendo de la vetana activa

F2:: ; explorador de Windows
IfWinNotExist ahk_class CabinetWClass
  ...
  ; cada aplicacion debera tener un grupo distinto, no seas flojo
...
; No he encontrado otra forma de terminarlo, la linea anterior a esta tampoco
; ha sido probada.
; V.1.2 Ya se probó y efectivamente "#IfWinActive" solitario elimina cualquier
; condicional que impide que las combinaciones de telcas funcionen fuera del "#IfWinActive Ejemplo"
; adicionalmente #If tambien es util para esto
; revisar "https://autohotkey.com/docs/commands/_If.htm"


#IfWinActive ahk_class CabinetWClass ; todo lo siguiente funciona
  !+WheelUp::                        ; solamente en explorer
    Send {enter}                     ; es para navegar con la rueda del
  Return                             ; raton en el explorador
  +WheelUp::                         ; veremos si realmente vale la pena
    Send {right}
  Return
  +WheelDown::
    Send {left}
